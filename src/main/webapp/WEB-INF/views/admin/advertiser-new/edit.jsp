                ...
                <div class="tabbable-panel clearfix">
                    <div class="tabbable-line">
                        ...
                        <div class="tab-content">
                            <%@include file="/WEB-INF/views/admin/advertiser-new/partial/edit/advertiser-info.jsp" %>
                            <%@include file="/WEB-INF/views/admin/advertiser-new/partial/edit/gallery-ads.jsp" %>
                            <%@include file="/WEB-INF/views/admin/advertiser-new/partial/edit/slideshow-adds.jsp" %>
                            <%@include file="/WEB-INF/views/admin/advertiser-new/partial/edit/popup-ads.jsp" %>
                        </div>
                    </div>
                </div>
            </div>
